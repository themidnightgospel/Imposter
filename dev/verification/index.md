...
- [Methods ▸ Verification](https://themidnightgospel.github.io/Imposter/dev/methods/verification/index.md) — method-focused examples.
- [Key API Reference](https://themidnightgospel.github.io/Imposter/dev/key-api-reference/#verification-counts) — quick signature list.
