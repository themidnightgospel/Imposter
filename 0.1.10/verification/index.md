...
- [Methods ▸ Verification](https://themidnightgospel.github.io/Imposter/0.1.10/methods/verification/index.md) — method-focused examples.
- [Key API Reference](https://themidnightgospel.github.io/Imposter/0.1.10/key-api-reference/#verification-counts) — quick signature list.
