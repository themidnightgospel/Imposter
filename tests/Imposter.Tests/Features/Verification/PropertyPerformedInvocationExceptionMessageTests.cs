    ...
    public class PropertyPerformedInvocationExceptionMessageTests
    {
        ...
        public void GivenPropertySetterCalledTooFewTimes_WhenVerificationFails_ShouldDescribePerformedInvocations()
        {
            ...
            entries
                ...
                .ShouldBe(
                    "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <30>"
                );
        ...
        public void GivenMultiplePropertySetterCalls_WhenVerificationFails_ShouldKeepOrdering()
        {
            ...
            exception
                ...
                .ShouldBe(
                    ...
                    {
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <30>",
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <20>",
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <10>",
                    }
                );
        ...
        public void GivenPropertySetterPredicateFails_WhenVerificationFails_ShouldListAllSetterInvocations()
        {
            ...
            exception
                ...
                .ShouldBe(
                    new[]
                    {
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <25>",
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <15>",
                        "set Imposter.Tests.Features.PropertyImpersonation.IPropertySetupSut.Age = <5>",
                    }
                );
