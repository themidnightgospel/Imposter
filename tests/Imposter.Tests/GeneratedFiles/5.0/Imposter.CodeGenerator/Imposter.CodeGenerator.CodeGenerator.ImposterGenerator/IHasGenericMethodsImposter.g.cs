...
namespace Imposter.Tests.Features.OpenGenericImposter
{
    ...
    public sealed class IHasGenericMethodsImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethods>
    {
        ...
        global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethods global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethods>.Instance()
        {
        ...
        internal class AddItemMethodImposter<TItem> : IAddItemMethodImposter<TItem>
        {
            ...
            public void Invoke(TItem item)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("void IHasGenericMethods.AddItem<TItem>(TItem item)");
                    }
                ...
                try
                {
                    matchingInvocationImposterGroup.Invoke(_invocationBehavior, "void IHasGenericMethods.AddItem<TItem>(TItem item)", item);
        ...
        internal class GetValueMethodImposter<TResult> : IGetValueMethodImposter<TResult>
        {
            ...
            public TResult Invoke()
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("TResult IHasGenericMethods.GetValue<TResult>()");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "TResult IHasGenericMethods.GetValue<TResult>()");
        ...
        internal class ProcessAsyncMethodImposter<TItem> : IProcessAsyncMethodImposter<TItem>
        {
            ...
            public global::System.Threading.Tasks.Task<TItem> Invoke(global::System.Collections.Generic.IEnumerable<TItem> items)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("Task<TItem> IHasGenericMethods.ProcessAsync<TItem>(IEnumerable<TItem> items)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "Task<TItem> IHasGenericMethods.ProcessAsync<TItem>(IEnumerable<TItem> items)", items);
        ...
        internal class ProcessComplexAsyncMethodImposter<TItem, TResult> : IProcessComplexAsyncMethodImposter<TItem, TResult>
        {
            ...
            public global::System.Threading.Tasks.Task<TResult> Invoke(global::System.Collections.Generic.IEnumerable<TItem> items)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("Task<TResult> IHasGenericMethods.ProcessComplexAsync<TItem, TResult>(IEnumerable<TItem> items)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "Task<TResult> IHasGenericMethods.ProcessComplexAsync<TItem, TResult>(IEnumerable<TItem> items)", items);
        ...
        public IHasGenericMethodsImposter(global::Imposter.Abstractions.ImposterMode invocationBehavior = global::Imposter.Abstractions.ImposterMode.Implicit)
        {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        class ImposterTargetInstance : global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethods
        {
            private readonly IHasGenericMethodsImposter _imposter;
            public ImposterTargetInstance(IHasGenericMethodsImposter _imposter)
            {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
    public static class IHasGenericMethodsImposterExtensions
    {
        extension(global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethods imposter)
        {
            public static global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethodsImposter Imposter() => new global::Imposter.Tests.Features.OpenGenericImposter.IHasGenericMethodsImposter();
        }
    }
}
#nullable restore
