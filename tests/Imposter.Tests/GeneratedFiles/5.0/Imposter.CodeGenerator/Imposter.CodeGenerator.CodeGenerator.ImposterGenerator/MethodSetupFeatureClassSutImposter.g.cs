...
namespace Imposter.Tests.Features.MethodImposter
{
    ...
    public sealed class MethodSetupFeatureClassSutImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSut>
    {
        ...
        internal class BuildLabelAsyncMethodInvocationHistory : IBuildLabelAsyncMethodInvocationHistory
        {
            ...
            {
                return "BuildLabelAsync(" + global::System.String.Join(", ", new[] { "prefix: " + FormatValue(Arguments.prefix), "suffix: " + FormatValue(Arguments.suffix) }) + ")" + " => " + FormatValue(Result) + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class BuildLabelAsyncMethodImposter
        {
            ...
            internal class Builder : IBuildLabelAsyncMethodImposterBuilder, IBuildLabelAsyncMethodInvocationImposterGroupContinuation
            {
                ...
                void BuildLabelAsyncInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _buildLabelAsyncMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
        ...
        internal class RefOutWithParamsMethodInvocationHistory : IRefOutWithParamsMethodInvocationHistory
        {
            ...
            public override string ToString()
            {
                return "RefOutWithParams(" + global::System.String.Join(", ", new[] { "seed: " + FormatValue(Arguments.seed), "adjustments: " + FormatValue(Arguments.adjustments) }) + ")" + " => " + FormatValue(Result) + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class RefOutWithParamsMethodImposter
        {
            ...
            internal class Builder : IRefOutWithParamsMethodImposterBuilder, IRefOutWithParamsMethodInvocationImposterGroupContinuation
            {
                ...
                void RefOutWithParamsInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    if (!count.Matches(invocationCount))
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _refOutWithParamsMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
        ...
        internal class SumAsyncMethodInvocationHistory : ISumAsyncMethodInvocationHistory
        {
            ...
            public override string ToString()
            {
                return "SumAsync(" + global::System.String.Join(", ", new[] { "left: " + FormatValue(Arguments.left), "right: " + FormatValue(Arguments.right) }) + ")" + " => " + FormatValue(Result) + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class SumAsyncMethodImposter
        {
            ...
            internal class Builder : ISumAsyncMethodImposterBuilder, ISumAsyncMethodInvocationImposterGroupContinuation
            {
                ...
                void SumAsyncInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    if (!count.Matches(invocationCount))
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _sumAsyncMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
        ...
        internal class ThrowingCalculationMethodInvocationHistory : IThrowingCalculationMethodInvocationHistory
        {
            ...
            public override string ToString()
            {
                return "ThrowingCalculation(" + global::System.String.Join(", ", new[] { "value: " + FormatValue(Arguments.value) }) + ")" + " => " + FormatValue(Result) + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class ThrowingCalculationMethodImposter
        {
            ...
            internal class Builder : IThrowingCalculationMethodImposterBuilder, IThrowingCalculationMethodInvocationImposterGroupContinuation
            {
                ...
                void ThrowingCalculationInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    if (!count.Matches(invocationCount))
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _throwingCalculationMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
        ...
        internal class VoidWithSideEffectMethodInvocationHistory : IVoidWithSideEffectMethodInvocationHistory
        {
            ...
            public override string ToString()
            {
                return "VoidWithSideEffect(" + global::System.String.Join(", ", new[] { "delta: " + FormatValue(Arguments.delta) }) + ")" + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class VoidWithSideEffectMethodImposter
        {
            ...
            internal class Builder : IVoidWithSideEffectMethodImposterBuilder, IVoidWithSideEffectMethodInvocationImposterGroupContinuation
            {
                ...
                void VoidWithSideEffectInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    if (!count.Matches(invocationCount))
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _voidWithSideEffectMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
    public static class MethodSetupFeatureClassSutImposterExtensions
    {
        extension(global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSut imposter)
        {
            public static global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSutImposter Imposter() => new global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSutImposter();
            public static global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSutImposter Imposter(global::Imposter.Abstractions.ImposterMode invocationBehavior = global::Imposter.Abstractions.ImposterMode.Implicit) => new global::Imposter.Tests.Features.MethodImposter.MethodSetupFeatureClassSutImposter(invocationBehavior);
        }
    }
}
#nullable restore
