...
using global::Imposter.Tests.Issues.Issue2;

namespace Imposter.Tests.Issues.Issue2
{
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
    public sealed class IIssue2SutImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.MethodImpersonation.IMethodParametersWithDefaultSut>
    {
        ...
        // int IIssue2Sut.BoolDefault(bool flag = true)
        ...
        internal class BoolDefaultMethodImposter
        {
            ...
            public int Invoke(bool flag = true)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.BoolDefault(bool flag = true)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.BoolDefault(bool flag = true)", flag);
        ...
        // int IIssue2Sut.CharDefault(char value = 'Z')
        ...
        internal class CharDefaultMethodImposter
        {
            ...
            public int Invoke(char value = 'Z')
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.CharDefault(char value = 'Z')");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.CharDefault(char value = 'Z')", value);
        ...
        // int IIssue2Sut.DecimalDefault(decimal value = 12.5)
        ...
        internal class DecimalDefaultMethodImposter
        {
            ...
            public int Invoke(decimal value = 12.5M)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.DecimalDefault(decimal value = 12.5)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.DecimalDefault(decimal value = 12.5)", value);
        ...
        // int IIssue2Sut.DoubleDefault(double value = 2.5)
        ...
        internal class DoubleDefaultMethodImposter
        {
            ...
            public int Invoke(double value = 2.5)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.DoubleDefault(double value = 2.5)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.DoubleDefault(double value = 2.5)", value);
        ...
        // int IIssue2Sut.EnumDefault(Issue2Enum mode = Issue2Enum.Second)
        ...
        internal class EnumDefaultMethodImposter
        {
            ...
            public int Invoke(global::Imposter.Tests.Features.MethodImpersonation.Issue2Enum mode = (global::Imposter.Tests.Features.MethodImpersonation.Issue2Enum)1)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.EnumDefault(Issue2Enum mode = Issue2Enum.Second)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.EnumDefault(Issue2Enum mode = Issue2Enum.Second)", mode);
        ...
        // int IIssue2Sut.FloatDefault(float value = 1.25)
        ...
        internal class FloatDefaultMethodImposter
        {
            ...
            public int Invoke(float value = 1.25F)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.FloatDefault(float value = 1.25)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.FloatDefault(float value = 1.25)", value);
        ...
        // int IIssue2Sut.IntDefault(int value = 5)
        ...
        internal class IntDefaultMethodImposter
        {
            ...
            public int Invoke(int value = 5)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.IntDefault(int value = 5)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.IntDefault(int value = 5)", value);
        ...
        // int IIssue2Sut.NameDefault(string name = "IIssue2Sut")
        public delegate int NameDefaultDelegate(string name = "IIssue2Sut");
        // int IIssue2Sut.NameDefault(string name = "IIssue2Sut")
        public delegate void NameDefaultCallbackDelegate(string name = "IIssue2Sut");
        // int IIssue2Sut.NameDefault(string name = "IIssue2Sut")
        public delegate global::System.Exception NameDefaultExceptionGeneratorDelegate(string name = "IIssue2Sut");
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        public class NameDefaultArguments
        {
            public string name;
            internal NameDefaultArguments(string name = "IIssue2Sut")
            {
                this.name = name;
            }
        }
        ...
        class NameDefaultMethodInvocationImposterGroup
        {
            ...
            public int Invoke(global::Imposter.Abstractions.ImposterMode invocationBehavior, string methodDisplayName, string name = "IIssue2Sut")
            {
                var invocationImposter = GetInvocationImposter();
                if (invocationImposter == null)
                {
            ...
            internal class MethodInvocationImposter
            {
                ...
                internal static int DefaultResultGenerator(string name = "IIssue2Sut")
                {
                    return default !;
                }
            }
        ...
        internal class NameDefaultMethodImposter
        {
            ...
            public int Invoke(string name = "IIssue2Sut")
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.NameDefault(string name = \"IIssue2Sut\")");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.NameDefault(string name = \"IIssue2Sut\")", name);
        ...
        // int IIssue2Sut.NullableDefault(string? text = null)
        ...
        internal class NullableDefaultMethodImposter
        {
            ...
            public int Invoke(string text = default(string))
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    if (_invocationBehavior == global::Imposter.Abstractions.ImposterMode.Explicit)
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IIssue2Sut.NullableDefault(string? text = null)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int IIssue2Sut.NullableDefault(string? text = null)", text);
        ...
        public IIssue2SutImposter(global::Imposter.Abstractions.ImposterMode invocationBehavior = global::Imposter.Abstractions.ImposterMode.Implicit)
        {
        ...
        {
            private readonly IIssue2SutImposter _imposter;
            public ImposterTargetInstance(IIssue2SutImposter _imposter)
            {
                this._imposter = _imposter;
            }
            ...
            public int NameDefault(string name = "IIssue2Sut")
            {
