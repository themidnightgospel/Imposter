...
namespace Imposter.Tests.Features.Docs.ArgumentsMatching
{
    ...
    public sealed class IArgumentMatchingServiceImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.Docs.ArgumentsMatching.IArgumentMatchingService>
    {
        ...
        // int IArgumentMatchingService.Add(int a, int b)
        ...
        // string IArgumentMatchingService.Format(string template, string value)
        ...
        // int IArgumentMatchingService.InOnly(in int input)
        ...
        // int IArgumentMatchingService.Increment(int value)
        ...
        // int IArgumentMatchingService.OutOnly(out int result)
        ...
        // int IArgumentMatchingService.RefOnly(ref int state)
        ...
        // int IArgumentMatchingService.Sum(params int[] values)
