...
namespace Imposter.Tests.Docs
{
    ...
    public sealed class MyServiceImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Docs.MyService>
    {
        ...
        global::Imposter.Tests.Docs.MyService global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Docs.MyService>.Instance()
        {
        ...
        // virtual int MyService.InvokeProtected(int value)
        public delegate System.Exception InvokeProtectedExceptionGeneratorDelegate(int value);
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
        ...
        internal class InvokeProtectedMethodInvocationHistory : IInvokeProtectedMethodInvocationHistory
        {
            ...
            public InvokeProtectedMethodInvocationHistory(InvokeProtectedArguments Arguments, int Result, System.Exception Exception)
            {
        ...
        {
            private readonly System.Collections.Concurrent.ConcurrentStack<IInvokeProtectedMethodInvocationHistory> _invocationHistory = new System.Collections.Concurrent.ConcurrentStack<IInvokeProtectedMethodInvocationHistory>();
        ...
        class InvokeProtectedMethodInvocationImposterGroup
        {
            ...
            internal class MethodInvocationImposter
            {
                ...
                private readonly System.Collections.Concurrent.ConcurrentQueue<InvokeProtectedCallbackDelegate> _callbacks = new System.Collections.Concurrent.ConcurrentQueue<InvokeProtectedCallbackDelegate>();
        ...
        public interface IInvokeProtectedMethodInvocationImposterGroup : IInvokeProtectedMethodInvocationImposterGroupCallback
        {
            ...
            IInvokeProtectedMethodInvocationImposterGroupContinuation Throws(System.Exception exception);
        ...
        {
            private readonly System.Collections.Concurrent.ConcurrentStack<InvokeProtectedMethodInvocationImposterGroup> _invocationImposters = new System.Collections.Concurrent.ConcurrentStack<InvokeProtectedMethodInvocationImposterGroup>();
            ...
            internal class Builder : IInvokeProtectedMethodImposterBuilder, IInvokeProtectedMethodInvocationImposterGroupContinuation
            {
                ...
                IInvokeProtectedMethodInvocationImposterGroupContinuation IInvokeProtectedMethodInvocationImposterGroup.Throws(System.Exception exception)
                {
                    _currentInvocationImposter.Throws((int value) =>
                    {
                        throw exception;
        ...
        // virtual int MyService.ProtectedAdd(int value)
        public delegate System.Exception ProtectedAddExceptionGeneratorDelegate(int value);
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
        ...
        internal class ProtectedAddMethodInvocationHistory : IProtectedAddMethodInvocationHistory
        {
            ...
            internal int Result;
            internal System.Exception Exception;
            public ProtectedAddMethodInvocationHistory(ProtectedAddArguments Arguments, int Result, System.Exception Exception)
            {
                this.Arguments = Arguments;
                this.Result = Result;
                this.Exception = Exception;
        ...
        {
            private readonly System.Collections.Concurrent.ConcurrentStack<IProtectedAddMethodInvocationHistory> _invocationHistory = new System.Collections.Concurrent.ConcurrentStack<IProtectedAddMethodInvocationHistory>();
        ...
        class ProtectedAddMethodInvocationImposterGroup
        {
            ...
            internal class MethodInvocationImposter
            {
                ...
                private readonly System.Collections.Concurrent.ConcurrentQueue<ProtectedAddCallbackDelegate> _callbacks = new System.Collections.Concurrent.ConcurrentQueue<ProtectedAddCallbackDelegate>();
                private bool _useBaseImplementation;
                internal bool IsEmpty => !_useBaseImplementation && ((_resultGenerator == null) && (_callbacks.Count == 0));
        ...
        public interface IProtectedAddMethodInvocationImposterGroup : IProtectedAddMethodInvocationImposterGroupCallback
        {
            IProtectedAddMethodInvocationImposterGroupContinuation Throws<TException>()
                where TException : System.Exception, new();
            IProtectedAddMethodInvocationImposterGroupContinuation Throws(System.Exception exception);
        ...
        {
            private readonly System.Collections.Concurrent.ConcurrentStack<ProtectedAddMethodInvocationImposterGroup> _invocationImposters = new System.Collections.Concurrent.ConcurrentStack<ProtectedAddMethodInvocationImposterGroup>();
            ...
            internal class Builder : IProtectedAddMethodImposterBuilder, IProtectedAddMethodInvocationImposterGroupContinuation
            {
                ...
                IProtectedAddMethodInvocationImposterGroupContinuation IProtectedAddMethodInvocationImposterGroup.Throws(System.Exception exception)
                {
                    _currentInvocationImposter.Throws((int value) =>
                    {
                        throw exception;
