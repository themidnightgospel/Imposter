...
[assembly: GenerateImposter(typeof(Imposter.Tests.Docs.BaseImpl.MyService))]

namespace Imposter.Tests.Docs.BaseImpl
{
    ...
    public class Methods_BaseImplementationCodeSnippetsTests
    {
        [Fact]
