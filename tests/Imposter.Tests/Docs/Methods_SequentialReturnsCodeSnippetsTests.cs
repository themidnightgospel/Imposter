...
[assembly: GenerateImposter(typeof(Imposter.Tests.Docs.Sequencing.ISeqService))]

namespace Imposter.Tests.Docs.Sequencing
{
    ...
    public class Methods_SequentialReturnsCodeSnippetsTests
    {
        [Fact]
