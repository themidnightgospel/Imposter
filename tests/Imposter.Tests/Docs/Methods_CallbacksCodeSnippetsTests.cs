...
[assembly: GenerateImposter(typeof(Imposter.Tests.Docs.Callbacks.ICallbackService))]

namespace Imposter.Tests.Docs.Callbacks
{
    ...
    public class Methods_CallbacksCodeSnippetsTests
    {
        [Fact]
