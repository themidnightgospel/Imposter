...
- [Methods ▸ Verification](https://themidnightgospel.github.io/Imposter/0.1.11/methods/verification/index.md) — method-focused examples.
- [Key API Reference](https://themidnightgospel.github.io/Imposter/0.1.11/key-api-reference/#verification-counts) — quick signature list.
