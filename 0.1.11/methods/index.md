...
`UseBaseImplementation()` applies only to non-abstract, virtual class members. It is not available for interfaces. See the dedicated page: [Base Implementation](https://themidnightgospel.github.io/Imposter/0.1.11/base-implementation/index.md).
...
- [Sequential Returns](https://themidnightgospel.github.io/Imposter/0.1.11/methods/sequential-returns/index.md)
- [Throwing Exceptions](https://themidnightgospel.github.io/Imposter/0.1.11/methods/throwing/index.md)
- [Verification](https://themidnightgospel.github.io/Imposter/0.1.11/methods/verification/index.md)
- [Callbacks](https://themidnightgospel.github.io/Imposter/0.1.11/methods/callbacks/index.md)
- [Base Implementation](https://themidnightgospel.github.io/Imposter/0.1.11/base-implementation/index.md)
- [Protected Methods](https://themidnightgospel.github.io/Imposter/0.1.11/methods/protected-members/index.md)
- [Imposter Modes](https://themidnightgospel.github.io/Imposter/0.1.11/implicit-vs-explicit/index.md)
