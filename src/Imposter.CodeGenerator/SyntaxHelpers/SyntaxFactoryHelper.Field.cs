...
internal static partial class SyntaxFactoryHelper
{
    ...
    internal static VariableDeclarationSyntax VariableDeclarationSyntax(TypeSyntax typeSyntax, string name, ExpressionSyntax? initializer = null)
        => VariableDeclaration(
            typeSyntax,
            SingletonSeparatedList(
                VariableDeclarator(Identifier(name), null, initializer is null ? null : EqualsValueClause(initializer))
            )
        );
