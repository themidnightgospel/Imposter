...
namespace Imposter.Playground
{
    ...
    public class IOrdinaryMethodPocV1Imposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Playground.IOrdinaryMethodPocV1>
    {
        ...
        global::Imposter.Playground.IOrdinaryMethodPocV1 global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Playground.IOrdinaryMethodPocV1>.Instance()
        {
        ...
        class AddMethodInvocationImposterGroup
        {
            ...
            public int Invoke(global::Imposter.Abstractions.ImposterInvocationBehavior invocationBehavior, string methodDisplayName, int a, int b)
            {
        ...
        internal class AddMethodImposter
        {
            ...
            private readonly global::Imposter.Abstractions.ImposterInvocationBehavior _invocationBehavior;
            public AddMethodImposter(AddMethodInvocationHistoryCollection _addMethodInvocationHistoryCollection, global::Imposter.Abstractions.ImposterInvocationBehavior _invocationBehavior)
            {
            ...
            public int Invoke(int a, int b)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int IOrdinaryMethodPocV1.Add(int a, int b)");
                    }
            ...
            internal class Builder : IAddMethodImposterBuilder, IAddMethodInvocationImposterGroupContinuation
            {
                ...
                IAddMethodInvocationImposterGroupContinuation IAddMethodInvocationImposterGroup.Throws(System.Exception exception)
                {
                    _currentInvocationImposter.Throws((int a, int b) =>
                    {
                        throw exception;
        ...
        public IOrdinaryMethodPocV1Imposter(global::Imposter.Abstractions.ImposterInvocationBehavior invocationBehavior = global::Imposter.Abstractions.ImposterInvocationBehavior.Implicit)
        {
