...
namespace Imposter.Ideation.GenericMethodPoc
{
#pragma warning disable nullable
    ...
    public delegate TResult PrintDelegate<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public delegate void PrintCallbackDelegate<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public delegate System.Exception PrintExceptionGeneratorDelegate<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public class PrintArgumentsCriteria<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    >
    {
        ...
        public PrintArgumentsCriteria(
            Arg<TOrdinaryParam> ordinaryParam,
            Arg<TInParam> inParam,
            Arg<TRefParam> refParam,
            Arg<TParamsParam[]> paramsParam
        )
        {
            this.ordinaryParam = ordinaryParam;
            this.inParam = inParam;
        ...
        >()
        {
            return new PrintArgumentsCriteria<
                TOrdinaryParamTarget,
                TOutParamTarget,
                TInParamTarget,
                TRefParamTarget,
            ...
            >(
                Arg<TOrdinaryParamTarget>.Is(it =>
                    TypeCaster.TryCast<TOrdinaryParamTarget, TOrdinaryParam>(
                        it,
                        out var ordinaryParamTarget
                    ) && ordinaryParam.Matches(ordinaryParamTarget)
                ),
                Arg<TInParamTarget>.Is(it =>
                    TypeCaster.TryCast<TInParamTarget, TInParam>(it, out var inParamTarget)
                    && inParam.Matches(inParamTarget)
                ),
                Arg<TRefParamTarget>.Is(it =>
                    TypeCaster.TryCast<TRefParamTarget, TRefParam>(it, out var refParamTarget)
                    && refParam.Matches(refParamTarget)
                ),
                Arg<TParamsParamTarget[]>.Is(it =>
                    TypeCaster.TryCast<TParamsParamTarget[], TParamsParam[]>(
                        it,
                        out var paramsParamTarget
                    ) && paramsParam.Matches(paramsParamTarget)
                )
            );
        }
    }
    ...
    {
        bool Matches<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam>(
            PrintArgumentsCriteria<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
    ...
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public class PrintMethodInvocationHistory<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    > : IPrintMethodInvocationHistory
    {
        ...
        public bool Matches<
            TOrdinaryParamCriteria,
            TOutParamCriteria,
            TInParamCriteria,
            TRefParamCriteria,
            TParamsParamCriteria
        >(
            PrintArgumentsCriteria<
                TOrdinaryParamCriteria,
                TOutParamCriteria,
        ...
        )
        {
            ...
            return criteria
                .As<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam>()
                .Matches(Arguments);
        }
    }
    ...
    {
        private readonly ConcurrentStack<IPrintMethodInvocationHistory> _invocationHistory =
            new ConcurrentStack<IPrintMethodInvocationHistory>();
        ...
        internal int Count<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam>(
            PrintArgumentsCriteria<
                TOrdinaryParam,
                TOutParam,
                TInParam,
    ...
    class PrintMethodInvocationsSetup<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    >
        ...
        >
    {
        internal static PrintMethodInvocationsSetup<
            TOrdinaryParam,
            TOutParam,
            TInParam,
            TRefParam,
            TResult,
            TParamsParam
        > DefaultInvocationSetup = new PrintMethodInvocationsSetup<
            TOrdinaryParam,
            TOutParam,
            TInParam,
            TRefParam,
        ...
        >(
            new PrintArgumentsCriteria<
                ...
                TParamsParam
            >(
                Arg<TOrdinaryParam>.Any(),
                Arg<TInParam>.Any(),
                Arg<TRefParam>.Any(),
                Arg<TParamsParam[]>.Any()
            )
        );

        internal PrintArgumentsCriteria<
            TOrdinaryParam,
            TOutParam,
            TInParam,
            TRefParam,
        ...
        public PrintMethodInvocationsSetup(
            PrintArgumentsCriteria<
                TOrdinaryParam,
                TOutParam,
                TInParam,
        ...
        public IPrintMethodInvocationsSetup<
            TOrdinaryParam,
            TOutParam,
            TInParam,
            TRefParam,
        ...
        public IPrintMethodInvocationsSetup<
            ...
            TParamsParam
        > Throws(
            PrintExceptionGeneratorDelegate<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
        ...
        internal class MethodInvocationSetup
        {
            ...
            internal PrintCallbackDelegate<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
    public interface IPrintMethodInvocationsSetup<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public interface PrintMethodInvocationVerifier<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
    // TResult ISutWithGenericMethod.Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
    public interface IPrintMethodImposterBuilder<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
    ...
    internal class PrintMethodImposter<
        TOrdinaryParam,
        TOutParam,
        TInParam,
        TRefParam,
        TResult,
        TParamsParam
    > : IPrintMethodImposter<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>
    {
        private readonly ConcurrentStack<
            PrintMethodInvocationsSetup<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
        ...
        {
            if (
                typeof(TOrdinaryParamTarget).IsAssignableTo(typeof(TOrdinaryParam))
        ...
        >
            ...
            >
        {
            private readonly PrintMethodImposter<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
            ...
            public TResultTarget Invoke(
                TOrdinaryParamTarget ordinaryParam,
                out TOutParamTarget outParam,
                in TInParamTarget inParam,
                ref TRefParamTarget refParam,
                TParamsParamTarget[] paramsParam
            )
            {
            ...
            )
            {
                return _target.HasMatchingSetup(
                    arguments.As<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam>()
                );
            }

            public IPrintMethodImposter<
                TOrdinaryParamTarget1,
                TOutParamTarget1,
                TInParamTarget1,
                TRefParamTarget1,
                TResultTarget1,
        ...
        {
            var arguments = new PrintArguments<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
                TParamsParam
            >(ordinaryParam, inParam, refParam, paramsParam);
            ...
            try
            {
                ...
                _printMethodInvocationHistoryCollection.Add(
                    new PrintMethodInvocationHistory<
                        TOrdinaryParam,
                        TOutParam,
                        TInParam,
                        TRefParam,
            ...
            >
        {
            ...
            private readonly PrintMethodInvocationHistoryCollection _printMethodInvocationHistoryCollection;
            private readonly PrintArgumentsCriteria<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
            ...
            private PrintMethodInvocationsSetup<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
            ...
            )
            {
                ...
                this._printMethodInvocationHistoryCollection =
                    printMethodInvocationHistoryCollection;
            ...
            > GetOrAddInvocationSetup()
            {
                ...
                {
                    existingInvocationSetup = new PrintMethodInvocationsSetup<
                        TOrdinaryParam,
                        TOutParam,
                        TInParam,
                        TRefParam,
                    ...
                    _printMethodImposterCollection
                        .AddNew<
                            ...
                            TParamsParam
                        >()
                        ._invocationSetups.Push(existingInvocationSetup);
            ...
            void PrintMethodInvocationVerifier<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
            ...
            >.Called(Count count)
            {
                var invocationCount = _printMethodInvocationHistoryCollection.Count(
                    _argumentsCriteria
                );
    ...
    {
        private readonly PrintMethodInvocationHistoryCollection _printMethodInvocationHistoryCollection;
        private readonly ConcurrentStack<IPrintMethodImposter> _imposters =
            new ConcurrentStack<IPrintMethodImposter>();

        public PrintMethodImposterCollection(
            PrintMethodInvocationHistoryCollection printMethodInvocationHistoryCollection
        )
        {
            _printMethodInvocationHistoryCollection = printMethodInvocationHistoryCollection;
        ...
        {
            var imposter = new PrintMethodImposter<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
    ...
    [System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
    public class GenericMethodPoc : IHaveImposterInstance<ISutWithGenericMethod>
    {
        private readonly PrintMethodImposterCollection _printMethodImposterCollection;
        private readonly PrintMethodInvocationHistoryCollection _printMethodInvocationHistoryCollection;

        public IPrintMethodImposterBuilder<
            TOrdinaryParam,
            TOutParam,
            TInParam,
            TRefParam,
            TResult,
            TParamsParam
        > Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(
            Arg<TOrdinaryParam> ordinaryParam,
            OutArg<TOutParam> outParam,
            Arg<TInParam> inParam,
            Arg<TRefParam> refParam,
            Arg<TParamsParam[]> paramsParam
        )
        {
            return new PrintMethodImposter<
                TOrdinaryParam,
                TOutParam,
                TInParam,
                TRefParam,
        ...
        {
            this._printMethodInvocationHistoryCollection =
                new PrintMethodInvocationHistoryCollection();
        ...
        class ImposterTargetInstance
            : global::Imposter.Ideation.GenericMethodPoc.ISutWithGenericMethod
        {
            ...
            {
                return _imposter
                    ._printMethodImposterCollection.GetImposterWithMatchingSetup<
                        TOrdinaryParam,
                        TOutParam,
                        TInParam,
                        TRefParam,
        ...
        global::Imposter.Ideation.GenericMethodPoc.ISutWithGenericMethod IHaveImposterInstance<global::Imposter.Ideation.GenericMethodPoc.ISutWithGenericMethod>.Instance()
        {
    ...
    {
        TResult Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(
            TOrdinaryParam ordinaryParam,
            out TOutParam outParam,
            in TInParam inParam,
            ref TRefParam refParam,
