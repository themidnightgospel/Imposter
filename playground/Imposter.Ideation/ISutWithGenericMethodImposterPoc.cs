...
namespace Imposters.Imposter.CodeGenerator.Tests.Setup.Methods.Generics.ISutWithGenericMethod
{
    ...
    internal class PrintMethodImposter<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam> : IPrintMethodImposter<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>
    {
        ...
        internal class Builder : IPrintMethodImposterBuilder<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>
        {
            ...
            private readonly PrintMethodInvocationsCollection _printMethodInvocationsCollection;
            private readonly PrintArgumentsCriteria<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam> _argumentsCriteria;

            private PrintMethodInvocationsSetup<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>? builtInvocationSetup;
                ...
                PrintArgumentsCriteria<TOrdinaryParam, TOutParam, TInParam, TRefParam, TParamsParam> argumentsCriteria)
            {
                ...
                this._printMethodInvocationsCollection = printMethodInvocationsCollection;
                this._argumentsCriteria = argumentsCriteria;
            }

            private PrintMethodInvocationsSetup<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam> BuildInvocationSetup()
            {
                if (builtInvocationSetup is null)
                {
                    builtInvocationSetup = new PrintMethodInvocationsSetup<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(_argumentsCriteria);
                    _printMethodImposterCollection.AddNew<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>()._invocationSetups.Push(builtInvocationSetup);
                }
                
                return builtInvocationSetup;
            }
            ...
            {
                var invocationSetup = BuildInvocationSetup();
            ...
            {
                var invocationCount = _printMethodInvocationsCollection.Count(_argumentsCriteria);
...
{
    [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
    public class ISutWithGenericMethodImposterPoc : IHaveImposterInstance<global::Imposter.CodeGenerator.Tests.Setup.Methods.Generics.ISutWithGenericMethod>
    {
            ...
            Arg<TOrdinaryParam> ordinaryParam, OutArg<TOutParam> outParam, Arg<TInParam> inParam, Arg<TRefParam> refParam, Arg<TParamsParam[]> paramsParam)
        {
            return new PrintMethodImposter<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>.Builder(
                ...
                _printMethodInvocationsCollection,
        ...
        public ISutWithGenericMethodImposterPoc()
        {
        ...
        {
            ISutWithGenericMethodImposterPoc _imposter;

            public ImposterTargetInstance(ISutWithGenericMethodImposterPoc _imposter)
            {
            ...
            public TResult Print<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(TOrdinaryParam ordinaryParam, out TOutParam outParam, in TInParam inParam, ref TRefParam refParam, TParamsParam[] paramsParam)
            {
                ...
                try
                {
                    ...
                    _imposter._printMethodInvocationsCollection.Add(new PrintMethodInvocationHistory<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(arguments, result));
                    return result;
                }
                catch (Exception ex)
                {
                    _imposter._printMethodInvocationsCollection.Add(new PrintMethodInvocationHistory<TOrdinaryParam, TOutParam, TInParam, TRefParam, TResult, TParamsParam>(arguments, default, ex));
                    throw;
                }
            }
        }
