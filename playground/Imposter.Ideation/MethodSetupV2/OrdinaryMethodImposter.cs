...
namespace Imposter.Playground
{
    ...
    public class IOrdinaryMethodPocImposter : Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Playground.IOrdinaryMethodPoc>
    {
        ...
        // TODO rename to MethodInvocationImposter
        // int IOrdinaryMethodPoc.Add(int a, int b)
        //  AddMethodInvocationsSetup
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "1.0.0.0")]
        class AddMethodInvocationImposterGroup
        {
            internal static AddMethodInvocationImposterGroup DefaultInvocationImposterGroup = new AddMethodInvocationImposterGroup(
            ...
            private AddMethodInvocationImposter _nextImposter;

            private AddMethodInvocationImposter? GetNextSetup()
            {
                if (_invocationImposters.TryDequeue(out var callSetup) && !callSetup.IsEmpty)
                {
                    _nextImposter = callSetup;
                }

                return _nextImposter;
            }
        ...
        internal class AddMethodInvocationImposter
        {
            ...
            internal AddCallbackDelegate? Callback { get; set; }
        ...
        internal class AddMethodImposter
        {
            ...
            private AddMethodInvocationImposterGroup? FindMatchingSetup(AddArguments arguments)
            {
            ...
            public int Invoke(int a, int b)
            {
                ...
                var matchingSetup = FindMatchingSetup(arguments) ?? AddMethodInvocationImposterGroup.DefaultInvocationImposterGroup;
                try
                {
            ...
            internal class Builder : IAddMethodImposterBuilder
            {
                ...
                {
                    _currentInvocationSetup.ResultGenerator = (a, b) => throw new TException();
                    return this;
                }

                IAddMethodInvocationImposterBuilder IAddMethodInvocationImposterBuilder.Throws(System.Exception exception)
                {
                    _currentInvocationSetup.ResultGenerator = (a, b) => throw exception;
                    return this;
                }
                ...
                {
                    _currentInvocationSetup.ResultGenerator = (a, b) => throw exceptionGenerator.Invoke(a, b);
                    return this;
                }
                ...
                {
                    _currentInvocationSetup.ResultGenerator = resultGenerator;
                    return this;
                }

                IAddMethodInvocationImposterBuilder IAddMethodInvocationImposterBuilder.Returns(int value)
                {
                    _currentInvocationSetup.ResultGenerator = (a, b) => value;
                    return this;
                }
