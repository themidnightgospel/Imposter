...
namespace Imposter.Benchmarks.ImposterVsMoqVsNSubstitute
{
    ...
    public sealed class ICalculatorImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Benchmarks.ImposterVsMoqVsNSubstitute.SimpleMethodMockingBenchmarks.ICalculator>
    {
        ...
        internal class SquareMethodInvocationHistory : ISquareMethodInvocationHistory
        {
            ...
            {
                return "Square(" + global::System.String.Join(", ", new[] { "input: " + FormatValue(Arguments.input) }) + ")" + " => " + FormatValue(Result) + (Exception == null ? "" : " threw " + FormatValue(Exception));
            }
        ...
        internal class SquareMethodImposter
        {
            ...
            public int Invoke(int input)
            {
                ...
                if (matchingInvocationImposterGroup == default)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.MissingImposterException("int SimpleMethodMockingBenchmarks.ICalculator.Square(int input)");
                    }
                ...
                try
                {
                    var result = matchingInvocationImposterGroup.Invoke(_invocationBehavior, "int SimpleMethodMockingBenchmarks.ICalculator.Square(int input)", input);
            ...
            internal class Builder : ISquareMethodImposterBuilder, ISquareMethodInvocationImposterGroupContinuation
            {
                ...
                void SquareInvocationVerifier.Called(global::Imposter.Abstractions.Count count)
                {
                    ...
                    {
                        throw new global::Imposter.Abstractions.VerificationFailedException(count, invocationCount, _squareMethodInvocationHistoryCollection.ToString());
                    }
                }
            }
        }
